...
export class AppComponent implements OnInit {
  ...
  onMarkerClickLocation(pos: number) {
    ...
    if (pos != this.length) {
      ...
      if (pos != this.previous) {
        ...
        if (this.latlong[pos].url == "assets/green.png" || this.latlong[pos].url == "assets/green_pink.png" || this.latlong[pos].url == "assets/green_blur.png") {
        ...
        if (this.previous != -1) {
          if (this.temp_estimated_gross_cash_flow[this.previous] >= this.gross_cash_flow_wo_expenses) {
            this.latlong[this.previous].url = "assets/green_pink.png";
            this.previous = pos;
          }

          else {
            this.latlong[this.previous].url = "assets/grey_pink.png";
            this.previous = pos;
          }
        }
  ...
  public Estimated_oil_price_model: number = 50;
